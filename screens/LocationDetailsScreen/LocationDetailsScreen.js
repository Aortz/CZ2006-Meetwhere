  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.detailsScroll}>
        <Text style={styles.infoText}>Address : {locationDetail.address.streetName}</Text>
        <Text style={styles.infoText}>Postal Code : {locationDetail.address.postalCode}</Text>
        <Text style={styles.infoText}>Website : {locationDetail.officialWebsite}</Text>
        <Text style={styles.infoText}>
          Opening Hours
          {/* Monday: {locationDetail.businessHour.openTime} - {locationDetail.businessHour.closeTime} */}
        </Text>
        <Text style={styles.infoText}>Amenities : {locationDetail.amenities}</Text>
        <Text style={styles.infoText}>Rating : {locationDetail.rating}</Text>
        <Text style={styles.infoText}>Destination Type : {locationDetail.type}</Text>
        ...
        <Text style={styles.gap}/>
        <View style={styles.buttonView}>
          <TouchableOpacity onPress={null} style={styles.buttonRandom}>
            <Image
