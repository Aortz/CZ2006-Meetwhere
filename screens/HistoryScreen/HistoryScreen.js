...
const HistoryScreen = (userDetails) => {
  ...
  const table = [
    { name: "Chinatown", timeOfVisit: "13042021" },
    { name: "MacDonalds", timeOfVisit: "13042021" },
    { name: "MacDonalds", timeOfVisit: "13042021" },
    { name: "MacDonalds", timeOfVisit: "13042021" },
    { name: "MacDonalds", timeOfVisit: "13042021" },
    { name: "MacDonalds", timeOfVisit: "13042021" },
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.textBox}>
            ...
            />
            <View>
              <Text style={styles.locationTextStyle}>Visited: {item.name}</Text>
              <Text style={styles.locationTextStyle}>
                Time Of Visit: {item.timeOfVisit}
              </Text>
            </View>
          </View>
        )}
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.border}>
        <Text style={styles.HeadStyle}>
          {userDetails.userDetails.userName}'s Past Locations
        </Text>
        <View style={styles.insideBorder}>{checkHistory(table)}</View>
      </View>
      <Image
        style={styles.banner}
